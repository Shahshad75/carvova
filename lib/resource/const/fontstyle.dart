...
class CustomFontStyles {
  static TextStyle normalOutfit =
      const TextStyle(fontFamily: "Outfit", color: Colors.black);

  static TextStyle hintstyleOne =
      TextStyle(fontFamily: "Outfit", color: Colors.black.withOpacity(1));
  ...
  /////////////////////////Home Screen///////////////////////////////////////////////
  static TextStyle tileStatusText = const TextStyle(
    fontFamily: "Outfit",
    fontSize: 13,
    fontWeight: FontWeight.w500,
    color: Colors.black,
